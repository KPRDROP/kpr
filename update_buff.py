...
This version:
 ...
 - Cleans event titles (removes site suffixes like "- BuffStreams - Watch Live...")
...
CATEGORIES = ["", "soccer-live-streams", "f1streams2", "nflstreams2", "nhlstreams2", "mlb-live-streams", "mmastreams2", "boxingstreams2",
...
def clean_event_title(raw_title):
    ...
    # We remove trailing phrases like: "- BuffStreams - Watch Live Sports, F1, UFC, NFL, TV"
    # or " - Watch Live Sports..." or " - BuffStreams"
